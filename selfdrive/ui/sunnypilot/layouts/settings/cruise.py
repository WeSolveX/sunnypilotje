...
class CruiseLayout(Widget):
  ...
  def _initialize_items(self):
    ...
    self.scc_a_toggle = toggle_item_sp(
      title=tr("Smart Cruise Control - Advisory"),
      description=tr("Use OSM advisory speed limits to slow down for roundabouts and tight curves."),
      param="SmartCruiseControlAdvisory")
  ...
  def _update_state(self):
    ...
    if ui_state.CP is not None and ui_state.CP_SP is not None:
      ...
      if has_long or has_icbm:
        ...
        self.scc_a_toggle.action_item.set_enabled(True)
      else:
        ui_state.params.remove("CustomAccIncrementsEnabled")
        ui_state.params.remove("DynamicExperimentalControl")
        ui_state.params.remove("SmartCruiseControlVision")
        ui_state.params.remove("SmartCruiseControlMap")
        ui_state.params.remove("SmartCruiseControlAdvisory")
        self.custom_acc_toggle.action_item.set_enabled(False)
        self.dec_toggle.action_item.set_enabled(False)
        self.scc_v_toggle.action_item.set_enabled(False)
        self.scc_m_toggle.action_item.set_enabled(False)
        self.scc_a_toggle.action_item.set_enabled(False)
